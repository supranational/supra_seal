...
./bin/pc2 -i $cache_512MiB -o $test_dir/pc2_test_512MiB
...
./bin/pc2 -i $cache_32GiB -o $test_dir/pc2_test_32GiB
...
./bin/tree_r -l $cache_32GiB/sc-02-data-layer-11.dat -d $cache_32GiB/staged-file -o $test_dir/tree-r_test_32GiB
...
./bin/tree_r_cpu -l $cache_32GiB/sc-02-data-layer-11.dat -d $cache_32GiB/staged-file -o $test_dir/tree-r-cpu_test_32GiB
