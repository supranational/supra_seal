...
Poseidon::Poseidon(const int arity) :
  ...
  switch (arity) {
  case 2:
    constants_file_ = (fr_t*)src_poseidon_constants_constants_2;
    constants_size_ = src_poseidon_constants_constants_2_len;
    break;
  case 4:
    constants_file_ = (fr_t*)src_poseidon_constants_constants_4;
    constants_size_ = src_poseidon_constants_constants_4_len;
    break;
  case 8:
    constants_file_ = (fr_t*)src_poseidon_constants_constants_8;
    constants_size_ = src_poseidon_constants_constants_8_len;
    break;
  case 11:
    constants_file_ = (fr_t*)src_poseidon_constants_constants_11;
    constants_size_ = src_poseidon_constants_constants_11_len;
    break;
  case 16:
    constants_file_ = (fr_t*)src_poseidon_constants_constants_16;
    constants_size_ = src_poseidon_constants_constants_16_len;
    break;
  case 24:
    constants_file_ = (fr_t*)src_poseidon_constants_constants_24;
    constants_size_ = src_poseidon_constants_constants_24_len;
    break;
  case 36:
    constants_file_ = (fr_t*)src_poseidon_constants_constants_36;
    constants_size_ = src_poseidon_constants_constants_36_len;
    break;
  default:
